...
public static class SettingEffectRegistry
{
    ...
    public static IReadOnlyList<SettingEffectBinding> All { get; } = new SettingEffectBinding[]
    {
        ...
        new("appearance.explorerTheme", SettingEffectOwner.Appearance, SettingEditorKind.FromCatalog, SettingApplySemantics.LivePreview, "settings.effect.appearance.explorerTheme", SettingEvidenceStatus.Unknown),
        ...
        new("general.newExplorerTabLastLocation", SettingEffectOwner.General, SettingEditorKind.FromCatalog, SettingApplySemantics.CommitOnly, "settings.effect.general.newExplorerTabLastLocation", SettingEvidenceStatus.Unknown),
        new("general.newExplorerTabDefaultDirectory", SettingEffectOwner.General, SettingEditorKind.FromCatalog, SettingApplySemantics.CommitOnly, "settings.effect.general.newExplorerTabDefaultDirectory", SettingEvidenceStatus.Unknown),
        ...
        new("tabs.navigateToFolderBehavior", SettingEffectOwner.TabsWorkspace, SettingEditorKind.FromCatalog, SettingApplySemantics.LivePreview, "settings.effect.tabs.navigateToFolderBehavior", SettingEvidenceStatus.Unknown),
