...
public static class HotkeyCatalog
{
    public static IReadOnlyList<HotkeyActionDefinition> All { get; } = new HotkeyActionDefinition[]
    {
        ...
        new("slideshow.stop", "Stop slideshow session", "Slideshow", GlideCommand.StopSlideshow, ["Shift+S"]),
        ...
        new("browser.back", "Explorer tab: Back", "Workspace", GlideCommand.BrowserBack, []),
        new("browser.forward", "Explorer tab: Forward", "Workspace", GlideCommand.BrowserForward, []),
        new("browser.up", "Explorer tab: Up one folder", "Workspace", GlideCommand.BrowserUp, []),
        ...
        new("file.containing", "Open containing folder", "File", GlideCommand.OpenContainingFolder, ["Ctrl+Shift+E"]),
