...
public sealed class DiagnosticsCoordinator
{
    ...
    {
        // The disk trace is deliberately independent of the optional in-memory queue. It is tiny,
        // auto-flushed, and survives renderer/native hard exits that never reach an export action.
        LiveDiagnosticTrace.Write(subsystem, name, data);
