...
internal sealed class WindowsBrowserFrameController : IDisposable
{
    ...
    public static WindowsBrowserFrameController? TryAttach(Window window, Button minimize, Button maximize, Button close, Func<PixelPoint, bool>? selectionHitTest = null, Func<PixelPoint, bool>? imageHitTest = null, Action? minimizeAction = null, Action? maximizeAction = null, Action? closeAction = null, Action? nativeResizeStarted = null, Action? nativeResizeEnded = null)
    {
        ...
        try { return new WindowsBrowserFrameController(window, minimize, maximize, close, platform.Handle, selectionHitTest, imageHitTest, minimizeAction, maximizeAction, closeAction, nativeResizeStarted, nativeResizeEnded); }
        catch { return null; }
    }
